function initialize() {
        ...
        if ($("#tests").attr("vis") == "off" || previnfo != $(this).attr("name")) {
            ...
            fetch('Lectures/Tests/dir.txt')
                ...
                .then(text => {
                    ...
                    numpt = 0;
                    $("#tests .pdf-move").html("");
                    if ($("#res-viewer .carousel").hasClass('slick-initialized')) {
                        $("#res-viewer .carousel").slick("unslick")
                        $("#res-viewer .carousel").html("")
                    }
                    ...
                    $("#res-viewer .carousel").append(append)

                    $("#res-viewer .carousel").slick({
                        arrows: true,
                        dots: false,
                        fade: false,
                        infinite: false,
                        slidesToScroll: 3,
                        slidesToShow: 3,
                        prevArrow: $('#set-viewer .prev'),
                        nextArrow: $('#set-viewer .next'),
                        responsive: [
                            {
                                breakpoint: 1024,
                                settings: {
    ...
    fetch('Lectures/Practice/dir.txt')
        ...
        .then(text => {
            ...
            nump = 0;
            $("#sets .pdf-move").html("");
            if ($("#set-viewer .carousel").hasClass('slick-initialized')) {
                $("#set-viewer .carousel").slick("unslick")
                $("#set-viewer .carousel").html("")
            }
            ...
            $("#set-viewer .carousel").append(append);
            $("#set-viewer .carousel").slick({
                arrows: true,
                dots: false,
                fade: false,
                infinite: false,
        ...
        fetch('Lectures/Practice/dir.txt')
            ...
            .then(text => {
                ...
                $("#set-viewer .carousel").slick({
                    ...
                    slidesToScroll: 3,
                    slidesToShow: 3,
                    prevArrow: $('#res-viewer .prev'),
                    nextArrow: $('#res-viewer .next'),
                    responsive: [
                        {
                            breakpoint: 1024,
                            settings: {
