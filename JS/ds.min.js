...
var DragSelect = function () {
    ...
    document.addEventListener('mousedown', function (event) {
        if (event.target.closest('p') || event.target.closest('a') || event.target.closest('img') || event.target.closest('td'))
            insidep = true;
        else {
            insidep = false;
            deselectAll();
    ...
    _createClass(DragSelect, [{
        ...
        value: function handleClick(event) {
            if (this.mouseInteraction) {
                // this.removeSelection(document.querySelectorAll('p'));
                return;
            }
        ...
        value: function _handleUnselection(item, force) {
            ...
            var posInSelectedArray = this._selected.indexOf(item);
            var isInPrevSelection = this._prevSelected.indexOf(item);
